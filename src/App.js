...
function App() {
  return (
    <div className="App">
      ...
      <div className="ETP">
        <div className="ETP_text mt-5">
          <h1>Easy to Play , Play to Earn </h1>
        </div>
        <div className="ETP_video mt-5">
        <img src={dot} alt="" className="ETP_dot"/>
          <div className="Video">
          <iframe width="100%" height="100%" src="https://www.youtube.com/embed/UUnl6ePcUtY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          {/* <iframe width="100%" height="100%" src="https://www.youtube.com/embed/LXb3EKWsInQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> */}
          {/* <iframe width="100%" height="100%" src="https://www.youtube.com/embed/XU0FYlY9_E0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> */}
            <div className="bg">
      ...
      <div className="M_NFT">
        <div className="NFT_S">
          <div className="NFT_t">
            ...
            <p className="mt-3">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. <br /> At scelerisque ut vestibulum nullam urna. Aliquet mollis <br /> tincidunt ut adipiscing vitae quis amet fames.
            </p>
          </div>
          <div className="NFT_m">
      ...
      <footer>
        <div class="footer_1">
          ...
          <div className="F_textt">
            <p className="">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. At scelerisque ut vestibulum nullam urna. Aliquet mollis tincidunt ut adipiscing vitae quis amet fames.
            </p>
          </div>
